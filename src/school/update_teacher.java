...
public class update_teacher extends JFrame implements ActionListener{
    ...
    update_teacher(){
        super("Update Teacher Detail");
        setExtendedState(MAXIMIZED_BOTH);
        Font f=new Font("Arial",Font.BOLD,40);        
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        
        backl=new JLabel();
        regl=new JLabel("Teacher Update Portal");
        regl.setFont(f);
        ...
        idcb=new JComboBox();
        idcb.setFont(f);
        idcb.addItem("Select Teacher ID");
        try{
            conn c1=new conn();
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(str.equals("comboBoxChanged")){
            try{
                conn c1=new conn();
                String q1="select * from teacher where id='"+(String)idcb.getSelectedItem()+"'";
                ResultSet rs=c1.s.executeQuery(q1);
                while(rs.next()){
            ...
            try{
                if(name.isEmpty()||sex.isEmpty()||maritial.isEmpty()||address.isEmpty()||country.isEmpty()||
                    ...
                    conn c1=new conn();
                    String q1="update teacher set name='"+name+"',sex='"+sex+"',maritial_status='"+maritial+"',"
                    ...
                    idcb.setSelectedItem("Select Teacher ID");nametf.setText("");maritialcb.setSelectedItem("Select Status");
